# Development and hardware notes

These notes preserve the September 20, 2026 development handoff. Some sections describe earlier iterations, acceptance settings, or test counts. Check the current code and configuration before using them as setup instructions. For the project overview, see [README.md](README.md).
